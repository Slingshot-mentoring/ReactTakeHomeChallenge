...
class HowItWorksComp extends Component<PropsType> {
  ...
  render() {
    ...
    return (
      ...
      else if(this.props.name==="Brainstorm"){
          return(
            <ScrollAnimation animateIn="fadeIn" duration={1.5} className="mentor-journey-section-style mobile-order-style">
            <div className="mentor-journey-section-content-style">
              <div className="mentor-journey-section-header-style">
      ...
      else if(this.props.name==="Incubate"){
          return(
            <ScrollAnimation animateIn="fadeIn" duration={1.5} className="mentor-journey-section-style mobile-order-style">
      ...
      else if(this.props.name==="Mentor"){
          return(
            <ScrollAnimation animateIn="fadeIn" duration={1.5} className="mentor-journey-section-style mobile-order-style">
            <div className="mentor-journey-section-content-style">
              <div className="mentor-journey-section-header-style">
      ...
      else if(this.props.name==="Slingshot"){
          return(
            <ScrollAnimation animateIn="fadeIn" duration={1.5} className="mentor-journey-section-style mobile-order-style">
